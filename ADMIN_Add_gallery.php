...
<head>
    ...
    <link rel="stylesheet" href="css/ADMIN_Add_gallery.css">
...
<body>
    ...
    <div class="add-image-header" style="margin-top:-1097px;">
        <p style="padding:13px;">&nbsp;&nbsp;Manage Gallery&nbsp;&nbsp;/&nbsp;&nbsp;Add Images</p>
    </div>
    <div class="add-image-main">
        <div class="add-image-main-box">
            <p><u>Add Gallery Images</u></p><br><br>
            <span style="padding-top:20px;">Upload Gallery Image&nbsp;</span><span style="color:#fc5404;">(width:560 px
                and height:373 px)</span><br>
            <div class="form">
                <form action="dblogic.php?q=20" method="POST" enctype="multipart/form-data">
