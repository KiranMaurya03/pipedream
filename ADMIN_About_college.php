    ...
    if(mysqli_num_rows($result) ==1){
        ...
        $sno = $data['sno'];
        $about_college=$data['about_college'];
    }else{
        $sno = "0";
        $about_college="";
    }
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/ADMIN_About_college.css">
    ...
    <body>
        ...
        <div class="add-image-header" style="margin-top:-1097px;">
            <p style="padding:13px;">&nbsp;&nbsp;Manage About Us&nbsp;&nbsp;/&nbsp;&nbsp;College Details</p>
        </div>
        <div class="add-image-main">
            <div class="add-image-main-box">
                <p><u>About College</u></p><br><br>
                <form action="dblogic.php?q=17" method="POST" enctype="multipart/form-data">
                    <br><textarea class=" csports_desc" name="about_college" required=""
                        style="width:1080px;height:270px; border-radius:10px;margin-left:10px; margin-top:-50px;">
                    <?php echo $about_college;?></textarea><br><br>
                    <span style="padding-top:20px;">Upload Photo&nbsp;</span><span style="color:#fc5404;">(File Should Be in
                        .jpg/.gif/.png Format)</span>
