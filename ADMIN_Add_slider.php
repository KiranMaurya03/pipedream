...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/ADMIN_Add_slider.css">
    ...
    <p style="padding:13px;">&nbsp;&nbsp;Manage Slider&nbsp;&nbsp;/&nbsp;&nbsp;Add Slider's Images</p>
    </div>
    <div class="add-image-main">    
        <div class="add-image-main-box" style="width:980px;">
        <p><u>Add Slider Images</u></p><br><br>
        <span style="padding-top:20px;">Upload Slider Images&nbsp;</span><span style="color:#fc5404;">(width:560 px and height:373 px)</span><br><br>
        <div class="form">
            <form action="dblogic.php?q=27" method="POST" enctype="multipart/form-data">
