...
<html>
    ...
    <p style="padding:13px;">&nbsp;&nbsp;Manage Students&nbsp;&nbsp;/&nbsp;&nbsp;View Registered Students</p>
    </div>
    <div class="add-image-main">    
        <div class="add-image-main-box">
        <p><u>Registered Student's Record</u></p><br><br>
    </div>
    </div>
        ...
        <div class="div-one">
            ...
            <table>
                ...
                <td style="font-weight:bold; font-size:17px;">Contact</td>
                <td style="font-weight:bold; font-size:17px;">Email</td>
                <td style="font-weight:bold; font-size:17px;">D.O.B.</td>
                <td style="font-weight:bold; font-size:17px;">Gender</td>
                <td style="font-weight:bold; font-size:17px;">Reg. Date</td>
                <td style="font-weight:bold; font-size:17px;">Login Status</td>
            ...
            <td style="text-align:center;"><?php echo $data["stu_semester"];?></td>
            <td><?php echo $data["stu_phone"];?></td>
            <td><?php echo $data["stu_email"];?></td>
            <td><?php echo $data["stu_dob"];?></td>
            <td><?php echo ($data["stu_gender"] == "M")?"Male":(($data["stu_gender"] == "F")?"Female":"Others");?></td>
            <td><?php echo $data["stu_added_on"];?></td>
            <td><?php echo ($data["stu_login_status"]== "T")?"Active":"Blocked";?></td>
            <td>
                <?php
                if($data["stu_login_status"]== "T"){?>
                    <a href="dblogic.php?q=10&stu_id=<?php echo $data["stu_id"];?>" style="text-decoration:none; color:green;">Block</a>
                <?php } else { ?>
                    <a href="dblogic.php?q=9&stu_id=<?php echo $data["stu_id"];?>" style="text-decoration:none; color:red;">Unblock</a>
                <?php
                }
                ?>
