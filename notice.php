...
$query2="select * from notice where active_status='T' order by date_time desc";
$result2=mysqli_query($conn,$query2);
?>
<!DOCTYPE html>
<html>
    <head>
        <title>iSports: Notice-Board</title>
    ...
    <body>
        ...
        <div class="notice-heading">
            <h1 style="font-size:80px; color:#fc5404;background-color: #f5f6f7; vertical-align: center;"><b>Notice-Board</b>
            </h1><br>
        </div><br><br>

        
                    <!-- <marquee width="60%" direction="up" height="100px" scrollamount="6">
                        This is a sample scrolling text that has scrolls in the upper direction.
                    </marquee>
                    <a class="href-mrq-two" href="pdf/christmas.pdf"><h2 class="mrg-h-two">Merry Christmas</h2></a> -->
            ...
            <h1 style="color: #323a45;text-align:center;"><?php echo $data["notice_title"];?></h1>
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()" width="90%" direction="up" height="100px"
                    scrollamount="3" style="margin-left:40px;"><a class="fa fa-file-pdf-o"
                        style="color:red; font-size:30px;"></a>&nbsp;&nbsp; <a class="href-mrq-two" style="font-size:20px;" href=""><?php echo $data["notice_description"];?></marquee> 
            </a>
