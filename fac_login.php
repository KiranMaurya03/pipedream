...
<html>
    <head>
        <title>iSports: fac_Login</title>
        <link rel="stylesheet" href="css/font-awesome.min.css" />
        <link rel="stylesheet" href="css/fac_login.css">
    ...
    <body>
        ...
        <?php
          ...
          <form action="dblogic.php?q=5" method="POST">
          <h1>Faculty Login</h1>
    ...
    <div id="foot-details">
        <footer id="fotr-details">
            ...
            <div class="foot-heading">
                ...
                <i class="fa fa-link"></i>&nbsp;&nbsp;<a href="https://play.google.com/store/apps/details?id=ums.lovely.university&hl=en_IN&gl=US" class="link">LPU TouchP</a><br><br>
