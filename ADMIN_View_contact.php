...
<head>
    ...
    <link rel="stylesheet" href="css/ADMIN_View_contact.css">
...
<body>
    ...
    <div class="add-image-header" style="margin-top:-1097px;width:1247px;">
        <p style="padding:10px;">&nbsp;&nbsp;Manage Contact Us&nbsp;&nbsp;/&nbsp;&nbsp;View Contact</p>
    </div>
    <div class="add-image-main">
        <div class="add-image-main-box">
            <p><u>Contact &nbsp;Record</u></p><br><br>
        </div>
    </div>
    <div class="table-div">
        <center>
            <table>
                <tr>
                    ...
                    <td style="font-weight:bold; font-size:17px;">Address</td>
                    <td style="font-weight:bold; font-size:17px;">Phone_No</td>
                    <td style="font-weight:bold; font-size:17px;">Mobile_No</td>
                    <td style="font-weight:bold; font-size:17px;">Email</td>
                    <td style="font-weight:bold; font-size:17px;">Uploaded_Date</td>
                </tr>
                <?php
