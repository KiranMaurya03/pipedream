...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/ADMIN_View_slider.css">
...
<!-- 
    ...
    <p style="padding:13px;">&nbsp;&nbsp;Manage Slider&nbsp;&nbsp;/&nbsp;&nbsp;View Slider</p>
    </div>
    <div class="add-image-main">    
        <div class="add-image-main-box">
        <p><u>Slider's Record</u></p><br><br>
    </div>
    </div>
    <div class="table-div">
        <table>
            ...
            <tr>
                ...
                <td><a href="dblogic.php?q=28&sno=<?php echo $data["sno"];?>" style="text-decoration:none;font-size:23px;color:red;margin-left:8px;"><a href="dblogic.php?q=28&nsno=<?php echo $data["sno"];?>" style="text-decoration:none;font-size:23px;color:red;margin-left:8px;"><i class="fa fa-trash-o"></i></a></td>
            </tr>
