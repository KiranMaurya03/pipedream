...
<html>
    <head>
        <title>iSports: fac_Registration</title>
        <link rel="stylesheet" href="css/font-awesome.min.css" />
        <link rel="stylesheet" href="css/fac_registration.css">
        <link rel="icon" href="images/logo/lpu.png">
        <script src="fac_registration.js"></script>
    </head>
    <body>
        ...
        <div class="two">
            ...
            if(isset($error)){
                if($error==0){
                    echo "<font color='#FF0000'><b>This E-mail Id or Faculty Id already has been registred.</b></font>";
                }
            }
?>

                <form class="form" action="dblogic.php?q=2" method="POST">
                    <h2 class="stud-reg-text">Faculty's Registration Form</h2>
                    <span class="sname">Name : </span> 
                    <input type="text" name="nname" required="" class="cname" placeholder="Enter your Name" required=""><br><br>
                    <span class="sname">Designation : </span>
                    <select  class="cdesignation" required="" required="" name="ndesignation"><option value="">Choose<span class="sname">Designation</option>
                    <option value="Assistant Professor">Assistant Professor</option>
                    <option value="Associate Professor" >Associate Professor</option>
                    <option value="Professor">Professor</option>
                    </select><br><br>
                    <span class="sname">Fac. ID : </span>
                    <input type="text" name="nfid" class="cfid" required="" placeholder="sms001" required=""><br><br>
                    ...
                    <input type="password" name="npassword" class="cpassword" required="" minlength="5" placeholder="Enter Your Password" required=""><br><br>
                    ...
                    <input type="radio" name="ngender" value="O" id="genother"><b><label for="genother">Others</label></b><br><br>
            ...
            <footer id="fotr-details">
                <div class="foot-heading">
                    ...
                    <div>
                        ...
                        <i class="fa fa-envelope">&nbsp;&nbsp;</i><a href="info@lpu.co.in" class="cont">info@lpu.co.in><br>
                    </div>
                </div>
                <div class="foot-heading">
