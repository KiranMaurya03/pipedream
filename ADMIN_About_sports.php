...
$query="select * from about_sports";
$result=mysqli_query($conn,$query);
if(mysqli_num_rows($result) ==1){
    $data = mysqli_fetch_assoc($result);
    $sno = $data['sno'];
    $about_sports=$data['about_sports'];
}else{
    $sno = "0";
    $about_sports="";
}
...
<head>
    ...
    <link rel="stylesheet" href="css/ADMIN_About_sports.css">
...
<body>
    ...
    <div class="add-image-header" style="margin-top:-1097px;">
        <p style="padding:13px;">&nbsp;&nbsp;Manage About Us&nbsp;&nbsp;/&nbsp;&nbsp;Sports Details</p>
    </div>
    <div class="add-image-main">
        <div class="add-image-main-box">
            <p><u>About Sports</u></p><br><br>
            <form action="dblogic.php?q=18" method="POST" enctype="multipart/form-data">
                <br><textarea class=" csports_desc" name="about_sports" required=""
                    style="width:1080px;height:270px; border-radius:10px;margin-left:10px; margin-top:-50px;">
                <?php echo $about_sports;?></textarea><br><br>
                <span style="padding-top:20px;">Upload Photo&nbsp;</span><span style="color:#fc5404;">(File Should Be in
                    .png Format)</span>
                <div style="height:30px;width:410px; border-radius:10px;">
                    <input type="file" class="cfile" name="nfile1" style="margin-top:8px;">
                    <input type="file" class="cfile" name="nfile2" style="margin-top:8px;">
                    <input type="file" class="cfile" name="nfile3" style="margin-top:8px;">
                </div><br>
