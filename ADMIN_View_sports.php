...
<head>
    ...
    <link rel="stylesheet" href="css/ADMIN_View_sports.css">
...
<body>
    ...
    <div class="add-image-header" style="margin-top:-1097px;">
        <p style="padding:13px;">&nbsp;&nbsp;Manage Sports&nbsp;&nbsp;/&nbsp;&nbsp;View Sports</p>
    </div>
    <div class="add-image-main">
        <div class="add-image-main-box">
            <p><u>Sports's Record</u></p><br><br>
        </div>
    </div>
    <div class="table-div">
        <table>
            ...
            <tr>
                ...
                <td style="text-align:justify;text-justify: inter-word;"><?php echo $data["sports_desc"];?></td>
                <td>
                    <form action="ADMIN_View_sports.php" method="POSt">
                        <img src="<?php echo $data["img"];?>" alt="photo" style="height:100px;width:100px;">
                    </form>
                </td>
                <td><?php echo $data["date_time"];?></td>
                <td><a href="ADMIN_edit_view_sports.php?sno=<?php echo $data["sno"];?>" style="text-decoration:none;font-size:23px;margin-left:8px;color:green"><i class="fa fa-pencil-square-o "></i></a></td>
                <td><a href="dblogic.php?q=22&nsno=<?php echo $data["sno"];?>" style="text-decoration:none;font-size:23px;color:red;margin-left:8px;"><i class="fa fa-trash-o"></i></a></td>
            </tr>
            <?php
                }
                ?>
