...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/ADMIN_Add_notice.css">
    ...
    <p style="padding:13px;">&nbsp;&nbsp;Manage Notice&nbsp;&nbsp;/&nbsp;&nbsp;Add Notice</p>
    </div>
    <div class="add-image-main">    
        <div class="add-image-main-box">
        <p><u>Add Notice</u></p><br><br>
        <form  action="dblogic.php?q=13" method="POST" enctype="multipart/form-data">
        <span>Notice Title: <input type="text" class="csports_name" required="" name="nnotice_title" required="" style="height:25px;width:210px; border-radius:10px;"></span><br><br>
        Notice Description:<textarea class="csports_name" name="nnotice_description" required="" style="height:65px;width:210px;border-radius:10px;margin-left:16px;"></textarea><br><br></br>
         <span style="padding-top:20px;">Upload Notice Files&nbsp;</span><span style="color:#fc5404;">(Maximum Size 2MB)</span>
    ...
    <!-- <div class="cover_photo">
        <img src="pdf\pdf.jpg" alt="photo" style="height:400px;width:500px;margin-left:908px;margin-top:-386px;border-radius:100px 0px 100px 0px;box-shadow:0px 0px 15px black;">
    </div> -->
    </div>
