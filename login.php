...
<html>
    ...
    <body>
        ...
        <div class="login-div">
            <h1 class="login-heading">Select for Login...</h1>
            <div class="link-href">
            <a href="stud_login.php" target="_blank" class="cstudent-login"><span style="margin:30%">Student</span></a><br><br>
            <a href="fac_login.php" target="_blank" class="cfaculty-login"><span style="margin:30%">Faculty</span></a><br><br>
            <a href="adm_login.php" target="_blank" class="cadmin-login"><span style="margin:30%">Admin</span></a>
            </div>
    </div>
        <div id="foot-details">
